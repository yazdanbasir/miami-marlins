...
Service runs at `http://localhost:1997`. Start with `uvicorn app:app --port 1993`.
...
```bash
curl "http://localhost:1997/schedule"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-01" | python3 -c "import json,sys; print(len(json.load(sys.stdin)))"
```
**Expect:** `11`
**Result:** ✅ `11`
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-01"  # check keys 385, 3276, 3277
curl "http://localhost:1997/schedule?date=2026-05-12"
curl "http://localhost:1997/schedule?date=2026-05-20"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-01"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-01-15"
```
...
```bash
curl "http://localhost:1997/schedule?date=04-01-2026"
```
**Expect:** 422.
...
```bash
curl "http://localhost:1997/schedule?date=abc"
```
**Expect:** 422.
**Result:** ✅ 422 — pattern mismatch.
...
```bash
curl "http://localhost:1997/schedule?date=2026-13-01"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-01"  # check key "146"
```
**Expect:**
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-01"  # check key "564"
```
**Expect:**
...
```bash
curl "http://localhost:1997/schedule?date=2026-03-27"  # check key "146"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-15"  # check keys 467, 619, 2127
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-06-15"  # check key 467
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-06-15"  # check keys 619, 2127
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-07-14"
```
...
```bash
curl "http://localhost:1997/schedule?date=2026-04-03"  # check key "554"
```
